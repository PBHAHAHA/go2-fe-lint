    ...
    if (!isTest) {
        ...
        if (!disableNpmInstall) {
            ...
            if (config.enableStylelint) {
                cross_spawn_1.default.sync(npm, ['i', '-D', 'stylelint@14.3.0', 'stylelint-scss@4.1.0', 'stylelint-config-go2', 'postcss-html', 'postcss-scss', 'postcss-less'], { stdio: 'inherit', cwd });
            }
