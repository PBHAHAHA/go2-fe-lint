...
var chooseVersion = function () { return __awaiter(void 0, void 0, void 0, function () {
    var version;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, inquirer_1.default.prompt({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, inquirer_1.default.prompt({
                    type: 'confirm',
                    name: 'enable',
                    message: "---".concat(++step, ". \u662F\u5426\u9700\u8981\u4F7F\u7528 stylelint\uFF08\u82E5\u6CA1\u6709\u6837\u5F0F\u6587\u4EF6\u5219\u4E0D\u9700\u8981\uFF09\uFF1A"),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, inquirer_1.default.prompt({
                    type: 'confirm',
                    name: 'enable',
                    message: "---".concat(++step, ". \u662F\u5426\u9700\u8981\u4F7F\u7528 markdownlint\uFF08\u82E5\u6CA1\u6709 Markdown \u6587\u4EF6\u5219\u4E0D\u9700\u8981\uFF09\uFF1A"),
                    default: true,
                })];
            case 1:
                enable = (_a.sent()).enable;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, inquirer_1.default.prompt({
                    type: 'confirm',
                    name: 'enable',
                    message: "---".concat(++step, ". \u662F\u5426\u9700\u8981\u4F7F\u7528 Prettier \u683C\u5F0F\u5316\u4EE3\u7801\uFF1A"),
                    default: true,
                })];
            case 1:
                enable = (_a.sent()).enable;
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 4:
                ...
                _e.label = 5;
            case 5:
                if (!options.version) return [3, 6];
                config.version = options.version;
                return [3, 8];
            case 6:
                _b = config;
                return [4, chooseVersion()];
            case 7:
                _b.version = _e.sent();
                _e.label = 8;
            case 8:
                if (!(typeof options.enableStylelint === 'boolean')) return [3, 9];
